...
public class Dungeon implements DungeonInterface {
  ...
  protected final List<Location> mapInList;
  protected final int interconnectivity;
  protected final boolean wrap;
  protected final double percent;
  protected final RandomInterface random;
  protected final int[] startEnd;
  ...
  public List<Treasure> getValidTreasure(int num) {
    List<Location> res = new ArrayList<>(mapInList);
    return res.get(num - 1).getTreasures();
  }
